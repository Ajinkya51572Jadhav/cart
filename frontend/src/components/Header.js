    ...
    <header className='h-16 shadow-md bg-white  fixed w-full z-40'  >
      <div className='container mx-auto h-full flex  items-center px-4 justify-between'>
        ...
        <div className=' lg:flex items-center w-full justify-between max-w-sm border rounded-full focus-within:shadow-sm pl-2'>
          ...
          <div className='text-lg min-w-[50px]  h-8 bg-yellow-500 hover:bg-yellow-600   flex items-center  justify-center  rounded-r-full text-white '>
            <GrSearch />
          </div>
        </div>
        ...
        <div className='flex items-center gap-7'>
          ...
          <NavLink to={"/cart"} className='text-2xl relative'>
            ...
            <div className='bg-yellow-500 hover:bg-yellow-600 text-white w-5 h-5 p-1 rounded-full flex items-center justify-center absolute -top-2 -right-3'>
          ...
          <div>
            {
              user?._id ? (
                <NavLink to={"/login"} onClick={logOut} className='px-3 py-1  bg-yellow-500 hover:bg-yellow-600 rounded-full'>logout</NavLink>
              ) : (
                <NavLink to={"/login"} className='px-3 py-1 bg-yellow-500 hover:bg-yellow-600  rounded-full '>Login</NavLink>
              )
            }
          </div>
