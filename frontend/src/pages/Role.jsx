  ...
  return (
    <div className="fixed  top-0 bottom-0 left-0  right-0 w-full h-full z-10 flex justify-between items-center bg-slate-200 bg-opacity-50 ">
      <div className="mx-auto bg-white  shadow-md p-4 w-full max-w-sm">
        <button className="block ml-auto rounded-full bg-red-400 p-2" onClick={()=>onClose(false)}>
        <IoMdClose />
        </button>
        ...
        <button className="w-fit mx-auto block border py-1 px-3 rounded-full bg-red-500 hover:bg-red-600"
          onClick={updateUser}
        > 
          Chnage Role
        </button>
